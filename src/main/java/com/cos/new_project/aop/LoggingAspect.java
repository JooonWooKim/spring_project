...
public class LoggingAspect {
    ...
    @Before("execution(* com.cos.new_project.service.*.get*(..))")
    public void loggerBefore() {
        System.out.println("get으로 시작하는 메서드가 시작됩니다.");
    }
 
    @After("execution(* com.cos.new_project.service.*.get*(..))")
    public void loggerAfter() {
        System.out.println("get으로 시작하는 메서드가 끝났습니다.");
    }
 
    @Around("execution(* com.cos.new_project.controller.UserController.*(..))")
